...
export function IconFileCode(props: IconProps): JSX.Element {
  const s = () => props.size ?? 14;
  return (
    <svg
      width={s()}
...
export function IconFileImage(props: IconProps): JSX.Element {
  const s = () => props.size ?? 14;
  return (
    <svg
      width={s()}
...
export function IconFileBinary(props: IconProps): JSX.Element {
  const s = () => props.size ?? 14;
  return (
    <svg
      width={s()}
...
export function IconFilePdf(props: IconProps): JSX.Element {
  ...
  return (
    ...
    >
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
      <polyline points="14 2 14 8 20 8" />
      <rect x="7.25" y="12.5" width="9.5" height="5.5" rx="1.25" />
      <line x1="9.5" y1="14" x2="9.5" y2="16.5" />
      <line x1="12" y1="14" x2="12" y2="16.5" />
      <line x1="14.5" y1="14" x2="14.5" y2="16.5" />
    </svg>
  );
}

export function IconLocate(props: IconProps): JSX.Element {
  const s = () => props.size ?? 14;
  return (
    <svg
      width={s()}
